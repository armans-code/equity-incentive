    ...
    <div className='flex flex-col items-center gap-10'>
      <div class='relative' id='home'>
        ...
        >
          ...
          <div class='blur-[106px] h-56 bg-gradient-to-br from-blue-500 to-orange-600 dark:from-blue-700'></div>
        </div>
        <slot>
          <div class='relative pt-28 ml-auto flex flex-col items-center'>
            <div class='lg:w-2/3 w-10/12 text-center mx-auto'>
              ...
              <p class='mt-8 text-gray-700 dark:text-gray-300'>
                The Equity Incentive strives to provide the resources and
                knowledge to all people on recognizing and battling inequity in
                all environments. Join us in our fight for equal opportunities
                for all.
              </p>
